        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (valid) {
                    ...
                    Booking book = new Booking (selectedClinic.getId(), loggedInPatient.getUsername(), id, selectedService.getId(), appointmentStartTime, today, selectedClinic, selectedService);
